...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Sum first and last digit of number 5 is " + FirstLastDigitSum.sumFirstAndLastDigit(5));        System.out.println("Sum first and last digit of number 252 is " + FirstLastDigitSum.sumFirstAndLastDigit(252));
